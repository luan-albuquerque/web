...
class Fapt(models.Model):
    TipoDePublicacao = models.CharField(max_length=40)
    NumeroDaPublicacao = models.CharField(max_length=40)
    Revisao = models.CharField(max_length=40)
    DataEfetividade = models.CharField(max_length=40)
    DocAssociado = models.CharField(max_length=40)
    Emissor = models.CharField(max_length=40)
    ATA = models.CharField(max_length=40)
    Assunto = models.CharField(max_length=40)
    Categoria = models.CharField(max_length=40)
    Tipo = models.CharField(max_length=40)
    Aplicabilidade = models.CharField(max_length=40)
    DescAplicabilidade = models.CharField(max_length=40)
    Acao = models.CharField(max_length=40)
    Analista = models.CharField(max_length=40)
    TSN = models.CharField(max_length=40)
    DataAnalise = models.CharField(max_length=40)
    TipoDeControle = models.CharField(max_length=40)
    CSN = models.CharField(max_length=40)
    DataLimite = models.CharField(max_length=40)
    Justificativa = models.CharField(max_length=1000)
    def __str__(self):
        return self.TipoDePublicacao + " " + self.NumeroDaPublicacao + " " + self.Revisao + " " + self.DataEfetividade + " " + self.DocAssociado + " " + self.Emissor + " " + self.ATA+ " " + self.Assunto + " " + self.Categoria + " " + self.Tipo + " " + self.Aplicabilidade + " " + self.DescAplicabilidade + " " + self.Acao + " " + self.Analista + " " + self.TSN + " " + self.DataAnalise + " " + self.TipoDeControle + " " + self.CSN + " " + self.DataLimite + " " + self.Justificativa